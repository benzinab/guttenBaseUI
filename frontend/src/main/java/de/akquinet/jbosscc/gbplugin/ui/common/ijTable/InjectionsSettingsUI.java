package de.akquinet.jbosscc.gbplugin.ui.common.ijTable;
...
public final class InjectionsSettingsUI extends SearchableConfigurable.Parent.Abstract implements Configurable.NoScroll {
    ...
    public InjectionsSettingsUI(CfgInfo[] myInfos) {
        ...
        decorator = ToolbarDecorator.createDecorator(myInjectionsTable);
...
//
    ...
    private static List<InjInfo> getInjInfoList(final CfgInfo[] infos) {
        ArrayList<InjInfo> infoArrayList = new ArrayList<>();
        InjectionsSettingsUI.CfgInfo info1 = new InjectionsSettingsUI.CfgInfo(null, "1");
        InjectionsSettingsUI.CfgInfo info2 = new InjectionsSettingsUI.CfgInfo(null, "2");
        InjectionsSettingsUI.CfgInfo info3 = new InjectionsSettingsUI.CfgInfo(null, "3");
        InjectionsSettingsUI.InjInfo inj1 = new InjectionsSettingsUI.InjInfo(info1, true);
        InjectionsSettingsUI.InjInfo inj2 = new InjectionsSettingsUI.InjInfo(info2, true);
        InjectionsSettingsUI.InjInfo inj3 = new InjectionsSettingsUI.InjInfo(info3, true);
        infoArrayList.add(inj1);
        infoArrayList.add(inj2);
        infoArrayList.add(inj3);
