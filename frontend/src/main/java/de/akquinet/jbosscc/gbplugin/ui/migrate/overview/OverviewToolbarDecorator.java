...
public class OverviewToolbarDecorator extends ToolbarDecorator {
    private final JTable myTable;
    @Nullable
    private final ElementProducer<?> myProducer;

    public OverviewToolbarDecorator(@NotNull JTable table, @Nullable final ElementProducer<?> producer) {
        myTable = table;
        myProducer = producer;
    ...
    public JPanel createPanel(){
        installExtraUpdaters(e -> true);
        return super.createPanel();
    }

    public void installExtraUpdaters(AnActionButtonUpdater updater) {
        if (myAddActionEnabled && myAddAction != null && updater != null) {
            super.getActionsPanel().getAnActionButton(CommonActionsPanel.Buttons.ADD).addCustomUpdater(updater);
        }
