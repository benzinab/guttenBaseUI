 ...
 * @author M. Dahm
 */
public class MySwingScriptExecutorProgressIndicator implements ScriptExecutorProgressIndicator
{
    ...
    public MySwingScriptExecutorProgressIndicator(JDialog dialog)
    {
        _dialog = dialog;
