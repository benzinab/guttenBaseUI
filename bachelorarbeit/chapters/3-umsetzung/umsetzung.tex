...
Dieser Abschnitt beschäftigt sich mit der Implementierung des GuttenBase Plugins. Es werden die verwendeten Technologien erläutert, die Anforderungen aus dem Abschnitt \ref{anaylse} umgesetzt und die resultierende Anwendungsoberfläche dargestellt.
%Es werden einige 
